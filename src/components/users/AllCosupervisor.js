...
export default function Allsupervisor() {
  ...
  const onAdd = (id) => {
    //adds co-supervisor to stud array
    if (stud.includes(id)) {
      return;
      ...
      >
        ...
        <TableContainer className="usersList">
          <Table variant="simple">
            <TableCaption>
              {!hasSupervisor && (
                <Button onClick={onOpen}>View Co-Supervisor</Button>
              )}
              {hasSupervisor && (
                <Text color="red" fontSize="lg">
                  Your group has a Co-Supervisor
                </Text>
              )}
            </TableCaption>
            <Thead>
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <ModalFooter>
              ...
              {
                <Button colorScheme="twitter" onClick={handleGetCoSupervisor}>
                  Send Request
                </Button>
              }
            </ModalFooter>
